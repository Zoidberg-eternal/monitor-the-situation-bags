...
class WonderwallAgentProfile:
    ...
    # KYA attestation — ed25519 DID minted at simulation start.
    # Populated by SimulationKeyring.mint() in simulation_manager; stays None until then.
